...
import com.rentcar.beans.AwsS3Config;
...
public class AmazonUploadingFileServiceImpl implements AmazonUploadingFileService {
    ...
    @Override
    public String uploadFile(byte[] imageBytes, Long carId) throws IOException {
        ...
        s3Client.putObject(
                PutObjectRequest.builder()
                        ...
                        .key(String.format("%s/%s/%s.jpg", amazonS3Config.getFolder(), carId, imageUUID))
                        .build(),
